...
- эффект таланта возвращается как сырое число (`effect_now = уровень × effect_per_level`);
  применение эффектов к XP/кейсам/кэшбеку — следующий шаг (нужно зафиксировать единицы).
...
1. Применить эффекты талантов к расчётам (XP, шанс кейса, кэшбек) — зафиксировать единицы.
