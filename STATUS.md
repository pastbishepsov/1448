...
| GET  | `/api/v1/ws/admin?token=` | live-канал админки: session/shell/deposit/booking/ban/grant/chat (А6+Б) | admin |
...
**Админка**: `web/admin.html` — треки А0–А8 (2026-07-11) и Б0–Б7 (2026-07-16)
завершены (план, решения и итоги — **ADMIN.md**, точка входа админ-сессий).
...
`/ws/admin` (поллинг 7/30с — fallback); телефонная вёрстка.
