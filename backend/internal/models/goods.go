...
type Good struct {
	...
	// default:true убран (Е2-и2): с ним GORM не шлёт колонку при вставке
	// false, и позиция, созданная выключенной, приходила включённой — то есть
	// сразу продавалась. Единственное место создания Good задаёт Active явно.
